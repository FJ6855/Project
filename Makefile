...
game: 	Main.o Game.o InputHandler.o MenuSystem.o StartMenu.o HelpMenu.o HighscoreMenu.o PauseMenu.o Menu.o SystemModule.o Level.o LevelSegment.o HighscoreMenuRenderer.o ButtonRenderer.o Button.o MenuRenderer.o Renderer.o ResourceManager.o Texture.o Object.o Block.o BlinkingBlock.o SpeedBlock.o MovingBlock.o BlockRenderer.o Obstacle.o ObstacleRenderer.o Item.o ItemRenderer.o Health.o SpeedBoost.o Player.o PlayerRenderer.o Background.o BackgroundRenderer.o Score.o HighScore.o WriteNameMenu.o
	$(CCC) -o game Main.o Game.o InputHandler.o MenuSystem.o StartMenu.o HelpMenu.o HighscoreMenu.o PauseMenu.o Menu.o SystemModule.o Level.o LevelSegment.o HighscoreMenuRenderer.o ButtonRenderer.o Button.o MenuRenderer.o Renderer.o ResourceManager.o Texture.o Object.o Block.o BlinkingBlock.o SpeedBlock.o MovingBlock.o BlockRenderer.o Obstacle.o ObstacleRenderer.o Item.o ItemRenderer.o Health.o SpeedBoost.o Player.o PlayerRenderer.o Background.o BackgroundRenderer.o HighScore.o Score.o WriteNameMenu.o $(LFLAGS)
...
Health.o : Health.cpp Health.h
	$(CCC) -c Health.cpp $(LFLAGS)

SpeedBoost.o : SpeedBoost.cpp SpeedBoost.h
	$(CCC) -c SpeedBoost.cpp $(LFLAGS)
